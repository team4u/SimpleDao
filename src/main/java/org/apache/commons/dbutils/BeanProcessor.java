...
public class BeanProcessor {
    ...
    private <T> T createBean(ResultSet rs, Class<T> type,
                             Field[] props, int[] columnToProperty)
            throws SQLException {
    ...
    private void callSetter(Object target, Field prop, Object value)
        ...
        try {
            ...
            if (value instanceof java.util.Date) {
                final String targetType = param.getName();
            ...
            } else if (value instanceof String && param.isEnum()) {
                value = Enum.valueOf(param.asSubclass(Enum.class), (String) value);
            }

            // Don't call setter if the value object isn't the right type
            if (this.isCompatibleType(value, param)) {
                ReflectUtil.setFieldValue(target, prop, value);
            } else {
                throw new SQLException(
                        "Cannot set " + prop.getName() + ": incompatible types, cannot convert "
                                + value.getClass().getName() + " to " + param.getName());
    ...
    /**
     * Returns a Field[] for the given Class.
     *
     * @param c The Class to retrieve Fields for.
     * @return A Field[] describing the Class.
     * @throws SQLException if introspection failed.
     */
    private Field[] Fields(Class<?> c) {
     ...
     * <code>Field[]</code> for the bean property that matches
    ...
    protected int[] mapColumnsToProperties(ResultSetMetaData rsmd,
                                           Field[] props) throws SQLException {
