...
public abstract class AbstractQueryRunner {
    ...
    public void fillStatementWithBean(PreparedStatement stmt, Object bean,
                                      Field[] properties) throws SQLException {
        Object[] params = new Object[properties.length];
        for (int i = 0; i < properties.length; i++) {
            Field property = properties[i];
            params[i] = ReflectUtil.getFieldValue(bean, property);
        }
    ...
    public void fillStatementWithBean(PreparedStatement stmt, Object bean,
        ...
        Field[] descriptors = ReflectUtil.getFields(bean.getClass());

        Field[] sorted = new Field[propertyNames.length];
        for (int i = 0; i < propertyNames.length; i++) {
            ...
            boolean found = false;
            for (Field descriptor : descriptors) {
